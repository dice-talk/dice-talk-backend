-- 회원 데이터
INSERT INTO member (email, password, name, gender, birth, region, member_status, notification, total_dice, ci, created_at, last_modified_at)
VALUES 
('admin@example.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '관리자', 'MALE', '1990-01-01', '서울특별시 강남구', 'MEMBER_ACTIVE', true, 1000, 'CI123456', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('user1@example.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '일반회원1', 'MALE', '1991-01-01', '경기도 수원시', 'MEMBER_ACTIVE', true, 500, 'CI234567', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('user2@example.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '일반회원2', 'FEMALE', '1992-01-01', '인천광역시 부평구', 'MEMBER_ACTIVE', true, 300, 'CI345678', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
