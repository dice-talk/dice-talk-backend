...
-- 10. Chat data
INSERT INTO chat (message, member_id, chat_room_id, created_at)
VALUES ('여행 계획 세우신 분 있나요?', 1, 1, NOW()),
       ('제주도 맛집 추천해주세요!', 2, 2, NOW()),
       ('어제 본 영화 정말 재미있었어요.', 3, 3, NOW()),
       ('이 노래 들어보셨나요? 정말 좋아요.', 4, 4, NOW()),
       ('같이 게임할 사람 구해요!', 5, 5, NOW()),
       ('저는 다음 주에 부산 여행 갑니다!', 2, 1, NOW()),
       ('제주 흑돼지는 꼭 드셔보세요!', 3, 2, NOW()),
       ('그 영화 저도 봤어요. 결말이 충격적이었죠!', 1, 3, NOW()),
       ('저도 그 노래 좋아해요. 같은 가수의 다른 노래도 추천합니다.', 5, 4, NOW()),
       ( '저랑 같이 해요! 지금 접속 중이에요.', 4, 5, NOW());
